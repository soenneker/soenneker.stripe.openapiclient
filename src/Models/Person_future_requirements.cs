...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class Person_future_requirements : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public List<global::Soenneker.Stripe.OpenApiClient.Models.Account_requirements_alternative> Alternatives { get; set; }
#endif
        /// <summary>Fields that need to be collected to keep the person&apos;s account enabled. If not collected by the account&apos;s `future_requirements[current_deadline]`, these fields will transition to the main `requirements` hash, and may immediately become `past_due`, but the account may also be given a grace period depending on the account&apos;s enablement state prior to transition.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<global::Soenneker.Stripe.OpenApiClient.Models.Account_requirements_error> Errors { get; set; }
#endif
        /// <summary>Fields you must collect when all thresholds are reached. As they become required, they appear in `currently_due` as well, and the account&apos;s `future_requirements[current_deadline]` becomes set.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> EventuallyDue { get; set; }
#endif
        /// <summary>Fields that weren&apos;t collected by the account&apos;s `requirements.current_deadline`. These fields need to be collected to enable the person&apos;s account. New fields will never appear here; `future_requirements.past_due` will always be a subset of `requirements.past_due`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.Models.Person_future_requirements"/> and sets the default values.
        /// </summary>
        public Person_future_requirements()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.Person_future_requirements"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.Person_future_requirements CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.Person_future_requirements();
        }
        /// <summary>
