...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class Checkout_us_bank_account_payment_method_options : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options_setup_future_usage? SetupFutureUsage { get; set; }
...
#nullable restore
        ...
        /// </summary>
        public Checkout_us_bank_account_payment_method_options()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "setup_future_usage", n => { SetupFutureUsage = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options_setup_future_usage>(); } },
                { "target_date", n => { TargetDate = n.GetStringValue(); } },
                { "verification_method", n => { VerificationMethod = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options_verification_method>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options_setup_future_usage>("setup_future_usage", SetupFutureUsage);
            writer.WriteStringValue("target_date", TargetDate);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.Checkout_us_bank_account_payment_method_options_verification_method>("verification_method", VerificationMethod);
