...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody.WithIntentPostRequestBody_excluded_payment_method_types? ExcludedPaymentMethodTypes { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody.WithIntentPostRequestBody_excluded_payment_method_types ExcludedPaymentMethodTypes { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="string"/>, List&lt;global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1&gt;
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
...
#nullable restore
            ...
            public string String { get; set; }
#endif
            /// <summary>Composed type representation for type List&lt;global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public List<global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1>? WithIntentPostRequestBodyExcludedPaymentMethodTypesMember1 { get; set; }
#nullable restore
#else
            public List<global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1> WithIntentPostRequestBodyExcludedPaymentMethodTypesMember1 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody.WithIntentPostRequestBody_excluded_payment_method_types"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody.WithIntentPostRequestBody_excluded_payment_method_types CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                ...
                else if(parseNode.GetCollectionOfObjectValues<global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1>(global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1.CreateFromDiscriminatorValue)?.AsList() is List<global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1> withIntentPostRequestBodyExcludedPaymentMethodTypesMember1Value)
                {
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                {
                    writer.WriteCollectionOfObjectValues<global::Soenneker.Stripe.OpenApiClient.V1.Setup_intents.Item.WithIntentPostRequestBody_excluded_payment_method_typesMember1>(null, WithIntentPostRequestBodyExcludedPaymentMethodTypesMember1);
                }
            }
        }
    }
