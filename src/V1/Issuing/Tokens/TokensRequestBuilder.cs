...
using Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.Item;
...
namespace Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens
{
    ...
    {
        /// <summary>Gets an item from the Soenneker.Stripe.OpenApiClient.v1.issuing.tokens.item collection</summary>
        ...
        public global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.Item.WithTokenItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("token", position);
                return new global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.Item.WithTokenItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.TokensRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TokensRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/issuing/tokens?card={card}{&created*,ending_before*,expand*,limit*,starting_after*,status*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.TokensRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TokensRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/issuing/tokens?card={card}{&created*,ending_before*,expand*,limit*,starting_after*,status*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.TokensRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.TokensRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Tokens.TokensRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// &lt;p&gt;Lists all Issuing &lt;code&gt;Token&lt;/code&gt; objects for a given card.&lt;/p&gt;
        /// </summary>
