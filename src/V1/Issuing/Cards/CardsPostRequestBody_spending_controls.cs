...
namespace Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards
{
    ...
    public partial class CardsPostRequestBody_spending_controls : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public List<global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls_allowed_categories?>? AllowedCategories { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls_allowed_categories?> AllowedCategories { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls_blocked_categories?>? BlockedCategories { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls_blocked_categories?> BlockedCategories { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls_spending_limits>? SpendingLimits { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls_spending_limits> SpendingLimits { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls"/> and sets the default values.
        /// </summary>
        public CardsPostRequestBody_spending_controls()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Issuing.Cards.CardsPostRequestBody_spending_controls"/></returns>
