...
using Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods.Item;
...
namespace Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods
{
    ...
    public partial class Payment_methodsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods.Payment_methodsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Payment_methodsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/customers/{customer}/payment_methods{?allow_redisplay*,ending_before*,expand*,limit*,starting_after*,type*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods.Payment_methodsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Payment_methodsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/customers/{customer}/payment_methods{?allow_redisplay*,ending_before*,expand*,limit*,starting_after*,type*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods.Payment_methodsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods.Payment_methodsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Stripe.OpenApiClient.V1.Customers.Item.Payment_methods.Payment_methodsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// &lt;p&gt;Returns a list of PaymentMethods for a given Customer&lt;/p&gt;
        /// </summary>
