...
using Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Item;
...
namespace Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers
{
    ...
    public partial class Outbound_transfersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Outbound_transfersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Outbound_transfersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/treasury/outbound_transfers{?ending_before*,expand*,limit*,starting_after*,status*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Outbound_transfersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Outbound_transfersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/treasury/outbound_transfers{?ending_before*,expand*,limit*,starting_after*,status*}", rawUrl)
        {
        }
        /// <summary>
...
#endif
            if(ReferenceEquals(body, null)) throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/v1/treasury/outbound_transfers?financial_account={financial_account}{&ending_before*,expand*,limit*,starting_after*,status*}", PathParameters);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Outbound_transfersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Outbound_transfersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Outbound_transfersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// &lt;p&gt;Returns a list of OutboundTransfers sent from the specified FinancialAccount.&lt;/p&gt;
        /// </summary>
