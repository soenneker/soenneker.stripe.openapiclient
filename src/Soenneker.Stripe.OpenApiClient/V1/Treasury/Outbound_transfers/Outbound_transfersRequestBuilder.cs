...
namespace Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers
{
    ...
    public partial class Outbound_transfersRequestBuilder : BaseRequestBuilder
    {
        ...
        public Outbound_transfersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Outbound_transfers.Outbound_transfersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Outbound_transfersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "", rawUrl)
        {
        }
        /// <summary>
