...
namespace Soenneker.Stripe.OpenApiClient.V1.Treasury.Debit_reversals
{
    ...
    public partial class Debit_reversalsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Debit_reversalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/treasury/debit_reversals{?ending_before*,expand*,limit*,received_debit*,resolution*,starting_after*,status*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Debit_reversals.Debit_reversalsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Debit_reversalsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/treasury/debit_reversals{?ending_before*,expand*,limit*,received_debit*,resolution*,starting_after*,status*}", rawUrl)
        {
        }
        /// <summary>
