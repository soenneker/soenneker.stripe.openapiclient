...
namespace Soenneker.Stripe.OpenApiClient.V1.Treasury.Credit_reversals
{
    ...
    public partial class Credit_reversalsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Credit_reversalsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Treasury.Credit_reversals.Credit_reversalsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Credit_reversalsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "", rawUrl)
        {
        }
        /// <summary>
