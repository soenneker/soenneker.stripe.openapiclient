...
namespace Soenneker.Stripe.OpenApiClient.V1.Test_helpers.Issuing.Authorizations
{
    ...
    public partial class AuthorizationsPostRequestBody_risk_assessment_merchant_dispute_risk : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public AuthorizationsPostRequestBody_risk_assessment_merchant_dispute_risk()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Test_helpers.Issuing.Authorizations.AuthorizationsPostRequestBody_risk_assessment_merchant_dispute_risk"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.V1.Test_helpers.Issuing.Authorizations.AuthorizationsPostRequestBody_risk_assessment_merchant_dispute_risk CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.V1.Test_helpers.Issuing.Authorizations.AuthorizationsPostRequestBody_risk_assessment_merchant_dispute_risk();
        }
        /// <summary>
