...
using Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\billing\feedback_options
    /// </summary>
    ...
    public partial class Feedback_optionsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Item.Feedback_optionsItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Item.Feedback_optionsItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Feedback_optionsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Feedback_optionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/billing/feedback_options{?ending_before*,expand*,limit*,starting_after*,status*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Feedback_optionsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Feedback_optionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/billing/feedback_options{?ending_before*,expand*,limit*,starting_after*,status*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Stripe.OpenApiClient.Models.BillingFeedbackOption?> PostAsync(global::Soenneker.Stripe.OpenApiClient.Models.PostBillingFeedbackOptionsXWwwFormUrlencodedRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Stripe.OpenApiClient.Models.BillingFeedbackOption> PostAsync(global::Soenneker.Stripe.OpenApiClient.Models.PostBillingFeedbackOptionsXWwwFormUrlencodedRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Stripe.OpenApiClient.Models.PostBillingFeedbackOptionsXWwwFormUrlencodedRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Stripe.OpenApiClient.Models.PostBillingFeedbackOptionsXWwwFormUrlencodedRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Feedback_optionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Stripe.OpenApiClient.V1.Billing.Feedback_options.Feedback_optionsRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            public string StartingAfter { get; set; }
#endif
            /// <summary>Filter results to only include feedback options with the given status.</summary>
            [QueryParameter("status")]
            public global::Soenneker.Stripe.OpenApiClient.Models.GetBillingFeedbackOptionsStatusParameter? Status { get; set; }
        }
    }
}
