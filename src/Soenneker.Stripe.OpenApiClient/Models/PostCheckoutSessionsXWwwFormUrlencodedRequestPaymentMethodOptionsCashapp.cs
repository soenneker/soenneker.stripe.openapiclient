...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostCheckoutSessionsXWwwFormUrlencodedRequestPaymentMethodOptionsCashapp : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostCheckoutSessionsXWwwFormUrlencodedRequestPaymentMethodOptionsCashapp"/> and sets the default values.
        /// </summary>
        public PostCheckoutSessionsXWwwFormUrlencodedRequestPaymentMethodOptionsCashapp()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostCheckoutSessionsXWwwFormUrlencodedRequestPaymentMethodOptionsCashapp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostCheckoutSessionsXWwwFormUrlencodedRequestPaymentMethodOptionsCashapp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostCheckoutSessionsXWwwFormUrlencodedRequestPaymentMethodOptionsCashapp();
        }
        /// <summary>
