...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class TreasuryOutboundTransferReturnedDetails : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Reason for the return.</summary>
        public global::Soenneker.Stripe.OpenApiClient.Models.TreasuryOutboundTransfersResourceReturnedDetailsCode? Code { get; set; }
...
#nullable restore
        ...
        /// </summary>
        public TreasuryOutboundTransferReturnedDetails()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.TreasuryOutboundTransferReturnedDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.TreasuryOutboundTransferReturnedDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.TreasuryOutboundTransferReturnedDetails();
        }
        /// <summary>
