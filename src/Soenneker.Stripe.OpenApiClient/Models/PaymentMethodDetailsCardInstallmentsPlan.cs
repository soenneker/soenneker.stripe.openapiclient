...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PaymentMethodDetailsCardInstallmentsPlan : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public PaymentMethodDetailsCardInstallmentsPlan()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardInstallmentsPlan"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardInstallmentsPlan CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardInstallmentsPlan();
        }
        /// <summary>
