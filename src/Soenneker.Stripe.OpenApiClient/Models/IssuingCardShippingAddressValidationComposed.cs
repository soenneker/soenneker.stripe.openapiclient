...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class IssuingCardShippingAddressValidationComposed : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The address validation capabilities to use.</summary>
        public global::Soenneker.Stripe.OpenApiClient.Models.IssuingCardShippingAddressValidationMode? Mode { get; set; }
        /// <summary>The normalized shipping address.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.IssuingCardShippingAddressValidationNormalizedAddress? NormalizedAddress { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.IssuingCardShippingAddressValidationNormalizedAddress NormalizedAddress { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        public IssuingCardShippingAddressValidationComposed()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.IssuingCardShippingAddressValidationComposed"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.IssuingCardShippingAddressValidationComposed CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.IssuingCardShippingAddressValidationComposed();
        }
        /// <summary>
