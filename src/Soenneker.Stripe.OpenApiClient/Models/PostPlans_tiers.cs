...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostPlans_tiers : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostPlans_tiers"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostPlans_tiers CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostPlans_tiers();
        }
        /// <summary>
