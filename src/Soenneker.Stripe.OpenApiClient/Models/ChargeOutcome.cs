...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class ChargeOutcome : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome_advice_code? AdviceCode { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule? Rule { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule Rule { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "advice_code", n => { AdviceCode = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome_advice_code>(); } },
                ...
                { "rule", n => { Rule = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule>(global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome_advice_code>("advice_code", AdviceCode);
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule>("rule", Rule);
            writer.WriteStringValue("seller_message", SellerMessage);
            writer.WriteStringValue("type", Type);
            writer.WriteAdditionalData(AdditionalData);
        }
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::Soenneker.Stripe.OpenApiClient.Models.Rule"/>, <see cref="global::Soenneker.Stripe.OpenApiClient.Models.UnionBranch"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ChargeOutcome_rule : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.Stripe.OpenApiClient.Models.ChargeOutcome.ChargeOutcome_rule();
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(Rule != null || UnionBranch != null)
                {
                    return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(Rule, UnionBranch);
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            {
                if(ReferenceEquals(writer, null)) throw new ArgumentNullException(nameof(writer));
                writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.Rule>(null, Rule, UnionBranch);
            }
        }
    }
}
