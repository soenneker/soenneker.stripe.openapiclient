...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class IssuingAuthorizationVerificationDataAuthenticationExemption : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public IssuingAuthorizationVerificationDataAuthenticationExemption()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.IssuingAuthorizationVerificationDataAuthenticationExemption"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.IssuingAuthorizationVerificationDataAuthenticationExemption CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.IssuingAuthorizationVerificationDataAuthenticationExemption();
        }
        /// <summary>
