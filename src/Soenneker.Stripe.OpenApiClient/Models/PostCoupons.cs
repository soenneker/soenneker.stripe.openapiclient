...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostCoupons : IParsable
...
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_applies_to? AppliesTo { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_applies_to AppliesTo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_currency_options? CurrencyOptions { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_currency_options CurrencyOptions { get; set; }
#endif
        /// <summary>Specifies how long the discount will be in effect if used on a subscription. Defaults to `once`.</summary>
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_duration? Duration { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_metadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "applies_to", n => { AppliesTo = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_applies_to>(global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_applies_to.CreateFromDiscriminatorValue); } },
                { "currency", n => { Currency = n.GetStringValue(); } },
                { "currency_options", n => { CurrencyOptions = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_currency_options>(global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_currency_options.CreateFromDiscriminatorValue); } },
                { "duration", n => { Duration = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_duration>(); } },
                { "duration_in_months", n => { DurationInMonths = n.GetIntValue(); } },
                { "expand", n => { Expand = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "max_redemptions", n => { MaxRedemptions = n.GetIntValue(); } },
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_metadata>(global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_metadata.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_applies_to>("applies_to", AppliesTo);
            writer.WriteStringValue("currency", Currency);
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_currency_options>("currency_options", CurrencyOptions);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_duration>("duration", Duration);
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostCoupons_metadata>("metadata", Metadata);
