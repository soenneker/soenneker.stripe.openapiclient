...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostChargesChargeRefundXWwwFormUrlencodedRequest : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestMetadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestMetadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestReason? Reason { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestMetadata>(global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestMetadata.CreateFromDiscriminatorValue); } },
                { "payment_intent", n => { PaymentIntent = n.GetStringValue(); } },
                { "reason", n => { Reason = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestReason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestMetadata>("metadata", Metadata);
            writer.WriteStringValue("payment_intent", PaymentIntent);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefundXWwwFormUrlencodedRequestReason>("reason", Reason);
