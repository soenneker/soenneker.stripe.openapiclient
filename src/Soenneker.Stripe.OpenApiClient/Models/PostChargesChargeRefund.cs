...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostChargesChargeRefund : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_metadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_reason? Reason { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_metadata>(global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_metadata.CreateFromDiscriminatorValue); } },
                { "payment_intent", n => { PaymentIntent = n.GetStringValue(); } },
                { "reason", n => { Reason = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_metadata>("metadata", Metadata);
            writer.WriteStringValue("payment_intent", PaymentIntent);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefund_reason>("reason", Reason);
