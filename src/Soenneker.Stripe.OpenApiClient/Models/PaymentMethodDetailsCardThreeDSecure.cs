...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PaymentMethodDetailsCardThreeDSecure : IAdditionalDataHolder, IParsable
    {
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeExemptionIndicator? ExemptionIndicator { get; set; }
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeResult? Result { get; set; }
        /// <summary>Additional information about why 3D Secure succeeded or failed basedon the `result`.</summary>
        public global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeResultReason? ResultReason { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardThreeDSecure"/> and sets the default values.
        /// </summary>
        public PaymentMethodDetailsCardThreeDSecure()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardThreeDSecure"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardThreeDSecure CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PaymentMethodDetailsCardThreeDSecure();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "authentication_flow", n => { AuthenticationFlow = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeAuthenticationFlow>(); } },
                { "electronic_commerce_indicator", n => { ElectronicCommerceIndicator = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeElectronicCommerceIndicator>(); } },
                { "exemption_indicator", n => { ExemptionIndicator = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeExemptionIndicator>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeAuthenticationFlow>("authentication_flow", AuthenticationFlow);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeElectronicCommerceIndicator>("electronic_commerce_indicator", ElectronicCommerceIndicator);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.ThreeDSecureDetailsChargeExemptionIndicator>("exemption_indicator", ExemptionIndicator);
