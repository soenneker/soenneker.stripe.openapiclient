...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class TopupResourcePaymentMethodOptionsUsBankAccount : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public TopupResourcePaymentMethodOptionsUsBankAccount()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.TopupResourcePaymentMethodOptionsUsBankAccount"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.TopupResourcePaymentMethodOptionsUsBankAccount CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.TopupResourcePaymentMethodOptionsUsBankAccount();
        }
        /// <summary>
