...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostChargesChargeRefunds : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_metadata Metadata { get; set; }
#endif
        /// <summary>Origin of the refund</summary>
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_origin? Origin { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_reason? Reason { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_metadata>(global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_metadata.CreateFromDiscriminatorValue); } },
                { "origin", n => { Origin = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_origin>(); } },
                { "payment_intent", n => { PaymentIntent = n.GetStringValue(); } },
                { "reason", n => { Reason = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_metadata>("metadata", Metadata);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_origin>("origin", Origin);
            writer.WriteStringValue("payment_intent", PaymentIntent);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostChargesChargeRefunds_reason>("reason", Reason);
