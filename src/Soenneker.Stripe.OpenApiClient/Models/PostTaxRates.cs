...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostTaxRates : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_metadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_tax_type? TaxType { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_metadata>(global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_metadata.CreateFromDiscriminatorValue); } },
                { "percentage", n => { Percentage = n.GetDoubleValue(); } },
                { "state", n => { State = n.GetStringValue(); } },
                { "tax_type", n => { TaxType = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_tax_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_metadata>("metadata", Metadata);
            writer.WriteDoubleValue("percentage", Percentage);
            writer.WriteStringValue("state", State);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTaxRates_tax_type>("tax_type", TaxType);
        }
    }
}
