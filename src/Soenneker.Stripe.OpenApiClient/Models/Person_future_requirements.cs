...
#nullable restore
        ...
        public List<string> EventuallyDue { get; set; }
#endif
        /// <summary>Fields that haven&apos;t been resolved by the account&apos;s `requirements.current_deadline`. These fields need to be resolved to enable the person&apos;s account. `future_requirements.past_due` is a subset of `requirements.past_due`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
