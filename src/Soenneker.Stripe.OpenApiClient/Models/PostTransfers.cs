...
namespace Soenneker.Stripe.OpenApiClient.Models
{
    ...
    public partial class PostTransfers : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_metadata? Metadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_metadata Metadata { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_source_type? SourceType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_metadata>(global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_metadata.CreateFromDiscriminatorValue); } },
                { "source_transaction", n => { SourceTransaction = n.GetStringValue(); } },
                { "source_type", n => { SourceType = n.GetEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_source_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_metadata>("metadata", Metadata);
            writer.WriteStringValue("source_transaction", SourceTransaction);
            writer.WriteEnumValue<global::Soenneker.Stripe.OpenApiClient.Models.PostTransfers_source_type>("source_type", SourceType);
